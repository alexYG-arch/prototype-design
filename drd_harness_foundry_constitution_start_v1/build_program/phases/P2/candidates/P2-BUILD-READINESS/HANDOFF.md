...
4. Confirm `test_tiny_brief_end_to_end.py` covers final artifacts, review binding, promotion readiness, and explicit `P2_BUILD_LOCK` state and lock readiness when present.
