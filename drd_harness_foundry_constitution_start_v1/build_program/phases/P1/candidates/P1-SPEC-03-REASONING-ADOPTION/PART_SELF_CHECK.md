...
| Missing surfaces beyond buttons, states, and inputs | `ELEMENT_DERIVATION_RULES.md`, `REASONING_VALIDATOR_SPEC.md` |
| Under-specified required page completion review | `ELEMENT_DERIVATION_RULES.md`, `REASONING_EXAMPLES.md`, `REASONING_IMPLEMENTATION_BLUEPRINT.md` |
...
4. Whether missing UX surface analysis covers page sections, child pages, data surfaces, lifecycle states, and nested flows, not only buttons, states, and inputs.
5. Whether required but under-specified page completion is correctly routed to Human Gate.
6. Whether PRD-explicit element adoption outcomes cover enough real conflict states.
7. Whether `RD-RULE-001` is represented as an actionable path or gap, not just a note.
8. Whether product expansion gaps are blocked from deterministic compilation inputs.
